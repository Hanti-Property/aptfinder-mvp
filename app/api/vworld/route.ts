...
export async function GET(request: NextRequest) {
  ...
  const url = `https://api.vworld.kr/req/data?service=data&request=GetFeature&data=LP_PA_CBND_BUBUN&key=${key}&domain=aptfinder-mvp.vercel.app&attrFilter=pnu:=:${pnu}&type=json`
