...
const GROUPS: Record<string, Col[]> = {
  ...
  인덱스: [
    ...
    { key: '_rvi', label: 'RVI', w: 55, ro: true, calc: r => cc(r)?.rvi ?? null },
    { key: '_rri', label: 'RRI %', w: 65, ro: true, calc: r => cc(r)?.rri ?? null },
    { key: '_faer', label: 'FAER %', w: 75, ro: true, calc: r => cc(r)?.faer ?? null },
