      ...
      <div className="p-5 space-y-5">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            <a href="/admin/recon" target="_blank" rel="noopener" className="bg-gradient-to-br from-[#2a2416] to-[#1e1e3f] border border-[#C49A3C]/40 rounded-xl p-4 hover:border-[#C49A3C] transition-all group">
            ...
            <a href="/admin/collector" target="_blank" rel="noopener" className="bg-gradient-to-br from-[#2a1a2e] to-[#1e1e3f] border border-purple-500/40 rounded-xl p-4 hover:border-purple-400 transition-all group">
              <div className="flex items-center justify-between mb-2">
                <span className="text-lg">🧭</span>
                <span className="text-2xl font-extrabold text-purple-300">AUTO</span>
              </div>
              <p className="text-[13px] font-semibold text-white">단지 자동수집·검수</p>
              <p className="text-[10px] text-gray-500 mt-0.5">지도 클릭→건축물대장·토지·실거래 자동조회</p>
            </a>
            <a href="/admin/docs" target="_blank" rel="noopener" className="bg-gradient-to-br from-[#16291c] to-[#1e1e3f] border border-emerald-500/40 rounded-xl p-4 hover:border-emerald-400 transition-all group">
              <div className="flex items-center justify-between mb-2">
                <span className="text-lg">📄</span>
            ...
            <a href="/admin/nvp" target="_blank" rel="noopener" className="bg-gradient-to-br from-[#16292a] to-[#1e1e3f] border border-teal-500/40 rounded-xl p-4 hover:border-teal-400 transition-all group">
              <div className="flex items-center justify-between mb-2">
                <span className="text-lg">🏙️</span>
            ...
            <a href="/admin/rvi" target="_blank" rel="noopener" className="bg-gradient-to-br from-[#1a2436] to-[#1e1e3f] border border-blue-500/40 rounded-xl p-4 hover:border-blue-400 transition-all group">
              <div className="flex items-center justify-between mb-2">
                <span className="text-lg">📊</span>
