...
function RichEditor({
  ...
  // value가 외부에서 비워질 때(발행 후 초기화)만 DOM 반영 — 입력 중 커서 튐 방지
  useEffect(() => {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-5">
              <div>
                ...
                <RichEditor value={contentHtml} onChange={setContentHtml} minHeight={340}
                  placeholder="핵심 내용을 간결하게 작성하세요. 툴바로 굵게·제목·목록 등 서식을 넣을 수 있습니다."
