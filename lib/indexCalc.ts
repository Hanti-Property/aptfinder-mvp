...
// 동별 기준 NVP (만원/전용평) — 매핑 폴백용. 강남 + 송파(잠실권).
// ※ 송파 기준가는 초기 추정. 단지 늘리며 실측·매핑(±20%)으로 조정.
export const NVP_V2_BASE: Record<string, number> = {
  // 강남구
  압구정동: 20000, 청담동: 17000, 대치동: 15000, 삼성동: 14000,
  개포동: 13000, 도곡동: 13000, 일원동: 13000,
  // 송파구 (초기 추정 — 잠실 신축 실거래 기반, 추후 조정)
  잠실동: 13000, 신천동: 13000, 문정동: 11000, 방이동: 11000,
  가락동: 11000, 송파동: 11000, 풍납동: 10000, 오금동: 10000, 마천동: 9000, 거여동: 9000,
  // 서초구 (초기 추정 — 반포 한강벨트 신축 기반)
  반포동: 18000, 잠원동: 16000, 서초동: 14000, 방배동: 13000, 양재동: 11000, 우면동: 10000,
  // 강동구 (초기 추정 — 고덕·둔촌 신축 기반)
  고덕동: 11000, 상일동: 11000, 둔촌동: 11000, 명일동: 10000, 암사동: 9000,
  천호동: 9000, 성내동: 9000, 길동: 9000, 강일동: 9000,
}
...
// RVI 점수화용 LOC 등급 (입지 프리미엄). 강남 + 송파.
// ※ 송파 등급은 초기 추정. 미정 동은 기본 50.
const LOC_G: Record<string, number> = {
  // 강남구
  압구정동: 100, 대치동: 100, 청담동: 100, 개포동: 80,
  도곡동: 80, 삼성동: 80, 논현동: 60, 일원동: 60,
  // 송파구 (초기 추정)
  잠실동: 80, 신천동: 80, 방이동: 60, 문정동: 60,
  가락동: 60, 송파동: 60, 풍납동: 50, 오금동: 50, 마천동: 40, 거여동: 40,
  // 서초구 (초기 추정 — 반포 한강벨트 상위)
  반포동: 100, 잠원동: 90, 서초동: 80, 방배동: 70, 양재동: 60, 우면동: 50,
  // 강동구 (초기 추정 — 고덕·둔촌 상위)
  고덕동: 70, 상일동: 60, 둔촌동: 70, 명일동: 60, 암사동: 50,
  천호동: 50, 성내동: 50, 길동: 50, 강일동: 50,
}
